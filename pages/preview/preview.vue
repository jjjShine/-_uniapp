	...
	<view class="preview" v-if="currentInfo">
		...
		<uni-popup ref="scorePopup" :is-mask-click="false">
			<view class="scorePopup">
				...
				<view class="footer">
					<button :disabled="!userScore||isScore" @click="submitScore" size="mini" plain>确认评分</button>
				</view>
			</view>
		</uni-popup>
	</view>
...
<script setup>
	...
	function readImgsFun() {
		readImgs.value.push((currentIndex.value + 11) % 12, currentIndex.value, (currentIndex.value + 1) % 12)
